...
export const RIDERS = {
  ...
  FEMALE_CIR: {
    id: "FEMALE_CIR",
    name: "Female Critical Illness Rider",
    desc: "Covers female-specific critical illnesses (cancer, stroke, etc.). Available only with Bima Lakshmi.",
    ratePerThousand: 2.00,
  },
};
...
export const TABULAR_RATES = {
  ...
  // 879: SMART PENSION (Immediate annuity — single premium)
  // Annual pension per ₹1000 purchase price
  879: {
    18: { immediate: 48.20 },
    25: { immediate: 52.60 },
    30: { immediate: 56.40 },
...
export const PLANS = [
  ...
  },
  {
    ...
    minAge: 0, maxAge: 60, minTerm: 15, maxTerm: 20, minSA: 125000, maxSA: null,
    ppt: "same", moneybkPayouts: [],
  ...
  },
  {
    ...
    minAge: 0, maxAge: 60, minTerm: 15, maxTerm: 25, minSA: 500000, maxSA: null,
    pptOptions: [{ ppt: 5, term: 15 }, { ppt: 8, term: 20 }, { ppt: 10, term: 25 }],
    ppt: "limited", moneybkPayouts: [],
    coverageMultiple: 7, // 7× annualised premium
    maturityFormula: "SA + Guaranteed Additions",
    gstCategory: "endowment", riders: ["ADB"],
    keyFeatures: ["Limited premium paying term (5/8/10 yrs)","Guaranteed additions throughout policy term","Non-participating — no market risk","Coverage = 7× annualised premium"],
  ...
  // ════════════════════════════════════════════
  {
    ...
    maturityFormula: "SA + bonuses + FAB",
    gstCategory: "endowment", riders: ["ADB", "TERM"],
    keyFeatures: ["New plan with enhanced death benefit","Annual bonus participation","Coverage = 7× annualised premium","Flexible term 15–25 years"],
  ...
  },
  {
    ...
    minAge: 18, maxAge: 55, minTerm: 15, maxTerm: 25, minSA: 200000, maxSA: null,
    ppt: "same", moneybkPayouts: [],
    defaultGender: "female",
    coverageMultiple: 10, // 10× annualised premium
    bimaLakshmiOption: "A", // Option A: 50% SA at end of PPT; Option B: deferral
    maturityFormula: "SA + bonuses + FAB",
    gstCategory: "endowment", riders: ["ADB", "TERM", "FEMALE_CIR"],
    keyFeatures: ["Exclusively for women","Option A: 50% SA survival benefit at end of PPT","Coverage = 10× annualised premium","Female Critical Illness Rider available","Min SA ₹2 lakh"],
  ...
  // ════════════════════════════════════════════
  {
    ...
    maturityAge: 100, // fixed maturity at age 100
  ...
  },
  {
    ...
    maturityAgeOptions: [75, 80, 85, 90, 95, 100], defaultMaturityAge: 100,
    maturityFormula: "SA + GA at chosen maturity age",
    gstCategory: "wholelife", riders: ["ADB"],
    keyFeatures: ["₹40 guaranteed additions per ₹1000 SA/yr during PPT","10% SA annual income for life after PPT","Select maturity age (75–100)","Min SA ₹5 lakh"],
  ...
  },
  {
    ...
    maturityFormula: "SA + GA at chosen maturity age",
    gstCategory: "singlePrem", riders: ["ADB"],
    keyFeatures: ["Pay once — income starts immediately","10% SA annual income for lifetime","Select maturity age (75–100)","Min SA ₹5 lakh"],
  ...
  },
  {
    ...
    minAge: 18, maxAge: 45, minTerm: 5, maxTerm: 30, minSA: 2000000, maxSA: null,
    ppt: "same", moneybkPayouts: [],
    interestProfile: "9%", // fixed interest rate for decreasing cover calculation
    maturityFormula: "No maturity — pure protection",
    gstCategory: "term", riders: [],
    keyFeatures: ["Decreasing SA matches loan outstanding","Interest profile 9% for loan balance calculation","Min SA ₹20 lakh","Age 18–45 only"],
  ...
  },
  {
    ...
    minAge: 18, maxAge: 65, minTerm: 1, maxTerm: 5, minSA: 37500, maxSA: 250000,
    ppt: "single", moneybkPayouts: [],
    smokerNonSmokerRates: true,
    maturityFormula: "No maturity — pure protection",
    gstCategory: "singlePrem", riders: [],
    keyFeatures: ["Single premium — pay once","Non-smoker discount available","Short 1–5 year terms","SA ₹37,500–₹2.5 lakh"],
  ...
  // ════════════════════════════════════════════
  {
    ...
    minAge: 30, maxAge: 79, minTerm: 0, maxTerm: 12, minSA: 150000, maxSA: null, minPurchasePrice: 150000,
    ppt: "single", moneybkPayouts: [],
  ...
  },
  {
    ...
    minAge: 25, maxAge: 100, minTerm: 0, maxTerm: 0, minSA: 100000, maxSA: null,
    ppt: "single", moneybkPayouts: [],
  ...
  },
  {
    ...
    minAge: 40, maxAge: 80, minTerm: 0, maxTerm: 0, minSA: 100000, maxSA: null, minPurchasePrice: 100000,
    ppt: "single", moneybkPayouts: [],
  ...
  },
  {
    ...
    category: "pension", type: "non-participating", status: "active",
    desc: "Single premium immediate annuity. Multiple annuity options including Option F (Life with ROPP). Age 18–100.",
    minAge: 18, maxAge: 100, minTerm: 0, maxTerm: 0, minSA: 100000, maxSA: null,
    ppt: "single", moneybkPayouts: [],
    annuityOptions: ["Life Annuity","Life with 5/10/15/20 yr Guaranteed","Joint Life Last Survivor","Life with ROPP (Option F)","Joint Life with ROPP"],
    minPurchasePrice: 100000,
    maturityFormula: "Annual pension for life",
    gstCategory: "singlePrem", riders: [],
    keyFeatures: ["Immediate annuity — pension starts next month","Option F: Life with Return of Purchase Price","Age 18–100 eligible","Flexible annuity options"],
    tags: ["Pension", "Immediate annuity", "Single premium"],
    bestFor: "Immediate pension from lump sum", xirr: "6.0–7.0%",
  ...
  },
  {
    ...
    minAge: 25, maxAge: 75, minTerm: 10, maxTerm: 42, minPremium: 30000,
  ...
  },
  {
    ...
    category: "ulip", type: "ulip", status: "active",
    desc: "Index-linked ULIP tracking NIFTY 100 and NIFTY 50.",
    minAge: 0, maxAge: 60, minTerm: 10, maxTerm: 25, minPremium: 30000,
    ...
    gstCategory: "ulip", riders: ["LADB"],
    keyFeatures: ["Tracks NIFTY 100 and NIFTY 50 indices","Lowest fund management charge (0.50%)","Coverage = 7× annualised premium","Withdrawn from new business Oct 2024"],
  ...
  },
  {
    ...
    minAge: 18, maxAge: 65, minTerm: 10, maxTerm: 25, minPremium: 30000,
    ppt: 5, // PPT is fixed at 5 years
    fundOptions: ULIP_FUNDS[886],
    fundManagementCharge: 0.0125,
    initialNAV: 22.7264, launchDate: "2025-12-03",
    lockIn: 5,
    maturityFormula: "Fund value at maturity",
    gstCategory: "ulip", riders: ["LADB"],
    keyFeatures: ["PPT fixed at 5 years only","6 fund options — most in LIC ULIP range","Includes NIFTY 100 and NIFTY 50 index funds","Initial NAV ₹22.7264 (launched Dec 2025)"],
  ...
  // ════════════════════════════════════════════
  {
    ...
    minAge: 18, maxAge: 55, minTerm: 10, maxTerm: 15, minSA: 100000, maxSA: 200000,
    ppt: "same", moneybkPayouts: [],
  ...
  // ════════════════════════════════════════════
  // WITHDRAWN PLANS
  // For legacy policyholder calculations only.
  // NOT shown in active plan suggestions or
  // wealth blueprint recommendations.
  // ════════════════════════════════════════════

  // ── Very old plans (pre-2000) ────────────────
  {
    id: "1", planNo: 1, name: "Whole Life", shortName: "Whole Life",
    category: "wholelife", type: "non-participating", status: "withdrawn",
    withdrawnDate: "1998-05-01",
    desc: "Without Profit Endowment Plan. Coverage for whole life with no bonus participation.",
    minAge: 16, maxAge: 60, minTerm: 10, maxTerm: 55, minSA: 10000,
    ppt: "same", gstCategory: "wholelife", riders: [],
    keyFeatures: ["Without profit — no bonus","Whole life cover","Pure protection plan"],
    tags: ["Withdrawn", "Whole life"],
  },
  {
    id: "3", planNo: 3, name: "Limited Payment Life Policy (Regular)", shortName: "LPL Regular",
    category: "endowment", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2003-02-15",
    desc: "Limited premium payment endowment. Pay for limited years, coverage continues for life.",
    minAge: 12, maxAge: 60, minTerm: 5, maxTerm: 55, minSA: 50000,
    ppt: "limited", gstCategory: "endowment", riders: [],
    keyFeatures: ["Limited premium paying term","Coverage continues after PPT","Min SA ₹50,000","Modes: Yly/Hly/Qly/Mly"],
    tags: ["Withdrawn", "Limited pay", "Endowment"],
  },
  {
    id: "7", planNo: 7, name: "Limited Payment Life Policy (Single)", shortName: "LPL Single",
    category: "endowment", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2003-02-15",
    desc: "Single premium limited payment endowment. Pay once, covered for life.",
    minAge: 12, maxAge: 60, minTerm: 5, maxTerm: 55, minSA: 50000,
    ppt: "single", gstCategory: "singlePrem", riders: [],
    keyFeatures: ["Single premium","Coverage for life","Without profit"],
    tags: ["Withdrawn", "Single premium"],
  },
  {
    id: "11", planNo: 11, name: "Endowment Policy (Without Profit)", shortName: "Endowment W/O Profit",
    category: "endowment", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2002-11-14",
    desc: "Basic without-profit endowment policy. Guaranteed SA at maturity or death.",
    minAge: 12, maxAge: 60, minTerm: 10, maxTerm: 35, minSA: 25000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Without profit","Guaranteed maturity"],
    tags: ["Withdrawn", "Endowment"],
  },
  {
    id: "14", planNo: 14, name: "Endowment Policy (With Profit)", shortName: "Endowment With Profit",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "Classic with-profit endowment. Bonus participation throughout policy term.",
    minAge: 12, maxAge: 60, minTerm: 10, maxTerm: 35, minSA: 25000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["With profit bonus","Classic endowment"],
    tags: ["Withdrawn", "Endowment", "With profit"],
  },
  {
    id: "17", planNo: 17, name: "Joint Life Endowment", shortName: "Joint Life Endowment",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "1998-05-01",
    desc: "Joint life with-profit endowment. Covers two lives under one policy.",
    minAge: 18, maxAge: 55, minTerm: 10, maxTerm: 30, minSA: 25000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Joint life cover","With profit"],
    tags: ["Withdrawn", "Joint life"],
  },
  {
    id: "18", planNo: 18, name: "Double Endowment Plan", shortName: "Double Endowment",
    category: "endowment", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2003-02-15",
    desc: "Without-profit endowment paying double the SA at maturity.",
    minAge: 12, maxAge: 60, minTerm: 10, maxTerm: 35, minSA: 25000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Double SA at maturity","Without profit"],
    tags: ["Withdrawn", "Endowment"],
  },
  {
    id: "27", planNo: 27, name: "Convertible Whole Life Policy", shortName: "Convertible WL",
    category: "wholelife", type: "participating", status: "withdrawn",
    withdrawnDate: "2003-08-31",
    desc: "Whole life policy convertible to endowment after 5 years if needed.",
    minAge: 16, maxAge: 55, minTerm: 10, maxTerm: 55, minSA: 25000,
    ppt: "same", gstCategory: "wholelife", riders: [],
    keyFeatures: ["Convert to endowment after 5 years","Whole life cover","With profit"],
    tags: ["Withdrawn", "Whole life", "Convertible"],
  },
  {
    id: "47", planNo: 47, name: "Limited Payment Endowment (Without Profits)", shortName: "LPE W/O Profit",
    category: "endowment", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2002-11-14",
    desc: "Limited pay without-profit endowment. Fixed SA at maturity, no bonus.",
    minAge: 12, maxAge: 55, minTerm: 10, maxTerm: 35, minSA: 25000,
    ppt: "limited", gstCategory: "endowment", riders: [],
    keyFeatures: ["Limited pay","Without profit","Guaranteed SA"],
    tags: ["Withdrawn", "Limited pay"],
  },
  {
    id: "48", planNo: 48, name: "Limited Payment Endowment (With Profits)", shortName: "LPE With Profit",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-04-01",
    desc: "Limited pay with-profit endowment. Bonus accrues throughout policy term.",
    minAge: 12, maxAge: 55, minTerm: 10, maxTerm: 35, minSA: 25000,
    ppt: "limited", gstCategory: "endowment", riders: [],
    keyFeatures: ["Limited pay","With profit bonus"],
    tags: ["Withdrawn", "Limited pay", "With profit"],
  },
  {
    id: "73", planNo: 73, name: "Money Back Plan (12 Years)", shortName: "Money Back 12yr",
    category: "moneyback", type: "participating", status: "withdrawn",
    withdrawnDate: "1994-09-01",
    desc: "12-year money back plan with periodic survival benefits.",
    minAge: 13, maxAge: 50, minTerm: 12, maxTerm: 12, minSA: 10000,
    ppt: "same", gstCategory: "moneyback", riders: [],
    keyFeatures: ["12-year term","Periodic survival benefits","With profit"],
    tags: ["Withdrawn", "Money back"],
  },
  {
    id: "74", planNo: 74, name: "Money Back Plan (15 Years)", shortName: "Money Back 15yr",
    category: "moneyback", type: "participating", status: "withdrawn",
    withdrawnDate: "1998-01-15",
    desc: "15-year money back plan. Survival benefits at 5th and 10th year.",
    minAge: 13, maxAge: 50, minTerm: 15, maxTerm: 15, minSA: 10000,
    ppt: "same", gstCategory: "moneyback", riders: [],
    keyFeatures: ["15-year term","Survival benefits at 5 & 10 years"],
    tags: ["Withdrawn", "Money back"],
  },
  {
    id: "75", planNo: 75, name: "Money Back Plan (20 Years)", shortName: "Money Back 20yr (old)",
    category: "moneyback", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-04-01",
    desc: "Predecessor to Plan 720. 20-year money back with survival benefits every 5 years.",
    minAge: 13, maxAge: 50, minTerm: 20, maxTerm: 20, minSA: 25000,
    ppt: 15, gstCategory: "moneyback", riders: [],
    keyFeatures: ["20-year term","20% SA every 5 years","Succeeded by Plan 720"],
    tags: ["Withdrawn", "Money back"],
  },
  {
    id: "88", planNo: 88, name: "Jeevan Mithra (Double Cover)", shortName: "Jeevan Mithra DC",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2013-11-24",
    desc: "Endowment with double sum assured on accidental death. With profit.",
    minAge: 18, maxAge: 55, minTerm: 15, maxTerm: 30, minSA: 50000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Double SA on accidental death","With profit bonus"],
    tags: ["Withdrawn", "Double cover"],
  },
  {
    id: "89", planNo: 89, name: "Jeevan Saathi", shortName: "Jeevan Saathi",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2013-11-24",
    desc: "Joint life double cover endowment. Covers husband & wife under one policy.",
    minAge: 18, maxAge: 50, minTerm: 15, maxTerm: 30, minSA: 50000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Joint life — husband & wife","Double cover on accidental death","With profit"],
    tags: ["Withdrawn", "Joint life", "Double cover"],
  },
  {
    id: "90", planNo: 90, name: "Marriage Endowment / Educational Annuity", shortName: "Marriage Endowment",
    category: "child", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "Child plan for marriage or education. Annuity payout on maturity for education/marriage.",
    minAge: 0, maxAge: 12, minTerm: 17, maxTerm: 27, minSA: 25000,
    ppt: "same", gstCategory: "child", riders: [],
    keyFeatures: ["For child's marriage/education","Annuity payout at maturity","With profit"],
    tags: ["Withdrawn", "Child", "Education"],
  },
  {
    id: "91", planNo: 91, name: "New Janaraksha", shortName: "New Janaraksha",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "Endowment with profit for low-income groups. Affordable premiums.",
    minAge: 18, maxAge: 55, minTerm: 10, maxTerm: 25, minSA: 10000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Low-cost endowment","With profit","For low-income groups"],
    tags: ["Withdrawn", "Endowment"],
  },
  {
    id: "93", planNo: 93, name: "Money Back Plan (25 Years)", shortName: "Money Back 25yr (old)",
    category: "moneyback", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "Predecessor to Plan 721. 25-year money back with 4 periodic payouts.",
    minAge: 13, maxAge: 45, minTerm: 25, maxTerm: 25, minSA: 25000,
    ppt: 20, gstCategory: "moneyback", riders: [],
    keyFeatures: ["25-year term","15% SA every 5 years (4 times)","Succeeded by Plan 721"],
    tags: ["Withdrawn", "Money back"],
  },
  {
    id: "94", planNo: 94, name: "Bima Sandesh", shortName: "Bima Sandesh",
    category: "endowment", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2002-02-18",
    desc: "Without-profit endowment for rural/semi-urban population.",
    minAge: 18, maxAge: 55, minTerm: 10, maxTerm: 25, minSA: 5000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Without profit","Rural focus","Low minimum SA"],
    tags: ["Withdrawn", "Rural"],
  },
  {
    id: "95", planNo: 95, name: "Bhavishya Jeevan", shortName: "Bhavishya Jeevan",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2004-07-15",
    desc: "Endowment with premium reduction after 5 years. With profit.",
    minAge: 18, maxAge: 55, minTerm: 15, maxTerm: 25, minSA: 50000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Premium reduces after 5 years","With profit","Unique premium structure"],
    tags: ["Withdrawn", "Endowment"],
  },
  {
    id: "96", planNo: 96, name: "Jeevan Dhara", shortName: "Jeevan Dhara",
    category: "pension", type: "participating", status: "withdrawn",
    withdrawnDate: "2000-02-16",
    desc: "Deferred annuity plan. Build pension corpus then convert to annuity.",
    minAge: 18, maxAge: 60, minTerm: 5, maxTerm: 35, minSA: 10000,
    ppt: "same", gstCategory: "pension", riders: [],
    keyFeatures: ["Deferred annuity","With profit","Pension building"],
    tags: ["Withdrawn", "Pension", "Annuity"],
  },
  {
    id: "97", planNo: 97, name: "Jeevan Akshay", shortName: "Jeevan Akshay (old)",
    category: "pension", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2000-02-16",
    desc: "Original immediate annuity plan. Succeeded by Jeevan Akshay VII (Plan 857).",
    minAge: 30, maxAge: 85, minTerm: 0, maxTerm: 0, minSA: 10000,
    ppt: "single", gstCategory: "singlePrem", riders: [],
    keyFeatures: ["Immediate annuity","Single premium","Succeeded by Plan 857"],
    tags: ["Withdrawn", "Pension", "Annuity"],
  },
  {
    id: "102", planNo: 102, name: "Jeevan Kishor", shortName: "Jeevan Kishor",
    category: "child", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "Child endowment plan. Risk commences from child's age 7.",
    minAge: 0, maxAge: 10, minTerm: 15, maxTerm: 25, minSA: 25000,
    ppt: "same", gstCategory: "child", riders: [],
    keyFeatures: ["Child plan","Risk from age 7","With profit"],
    tags: ["Withdrawn", "Child"],
  },
  {
    id: "103", planNo: 103, name: "Jeevan Chaya", shortName: "Jeevan Chaya",
    category: "moneyback", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "High risk cover money back plan. Enhanced death benefit with periodic payouts.",
    minAge: 18, maxAge: 50, minTerm: 20, maxTerm: 25, minSA: 50000,
    ppt: "same", gstCategory: "moneyback", riders: [],
    keyFeatures: ["High risk cover","Money back payouts","With profit"],
    tags: ["Withdrawn", "Money back", "High cover"],
  },
  {
    id: "106", planNo: 106, name: "Jeevan Surabhi (15 Year)", shortName: "Jeevan Surabhi 15yr",
    category: "moneyback", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "15-year money back with increasing survival benefits and with-profit bonus.",
    minAge: 13, maxAge: 55, minTerm: 15, maxTerm: 15, minSA: 25000,
    ppt: "same", gstCategory: "moneyback", riders: [],
    keyFeatures: ["15-year term","Increasing money back","With profit"],
    tags: ["Withdrawn", "Money back"],
  },
  {
    id: "107", planNo: 107, name: "Jeevan Surabhi (20 Year)", shortName: "Jeevan Surabhi 20yr",
    category: "moneyback", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "20-year money back with increasing survival benefits and with-profit bonus.",
    minAge: 13, maxAge: 50, minTerm: 20, maxTerm: 20, minSA: 25000,
    ppt: "same", gstCategory: "moneyback", riders: [],
    keyFeatures: ["20-year term","Increasing money back","With profit"],
    tags: ["Withdrawn", "Money back"],
  },
  {
    id: "108", planNo: 108, name: "Jeevan Surabhi (25 Year)", shortName: "Jeevan Surabhi 25yr",
    category: "moneyback", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "25-year money back with increasing survival benefits and with-profit bonus.",
    minAge: 13, maxAge: 45, minTerm: 25, maxTerm: 25, minSA: 25000,
    ppt: "same", gstCategory: "moneyback", riders: [],
    keyFeatures: ["25-year term","Increasing money back","With profit"],
    tags: ["Withdrawn", "Money back"],
  },
  {
    id: "109", planNo: 109, name: "Jeevan Sukanya", shortName: "Jeevan Sukanya",
    category: "child", type: "participating", status: "withdrawn",
    withdrawnDate: "2004-08-31",
    desc: "Children's plan specifically for girl child. Lump sum for education/marriage.",
    minAge: 0, maxAge: 10, minTerm: 15, maxTerm: 25, minSA: 25000,
    ppt: "same", gstCategory: "child", riders: [],
    keyFeatures: ["For girl child","Education/marriage fund","With profit"],
    tags: ["Withdrawn", "Child", "Girl"],
  },
  {
    id: "110", planNo: 110, name: "Asha Deep", shortName: "Asha Deep",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "1993-11-30",
    desc: "Health/endowment hybrid plan with critical illness benefit.",
    minAge: 18, maxAge: 55, minTerm: 10, maxTerm: 25, minSA: 25000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Health + endowment hybrid","CI benefit included"],
    tags: ["Withdrawn", "Health", "Endowment"],
  },
  {
    id: "111", planNo: 111, name: "Bima Kiran", shortName: "Bima Kiran",
    category: "term", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2002-02-18",
    desc: "Term assurance plan. Pure life cover without savings element.",
    minAge: 18, maxAge: 60, minTerm: 10, maxTerm: 30, minSA: 25000,
    ppt: "same", gstCategory: "term", riders: [],
    keyFeatures: ["Pure term cover","No maturity benefit","Without profit"],
    tags: ["Withdrawn", "Term"],
  },
  {
    id: "112", planNo: 112, name: "Jeevan Shree", shortName: "Jeevan Shree",
    category: "endowment", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2002-01-31",
    desc: "Non-par endowment with guaranteed additions. Predecessor to Bima Jyoti family.",
    minAge: 18, maxAge: 55, minTerm: 10, maxTerm: 25, minSA: 50000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Guaranteed additions","Without profit","Predecessor to GA plans"],
    tags: ["Withdrawn", "Endowment", "Guaranteed"],
  },
  {
    id: "113", planNo: 113, name: "Children's Money Back", shortName: "Children's MB (old)",
    category: "child", type: "participating", status: "withdrawn",
    withdrawnDate: "2002-03-31",
    desc: "Old children's money back plan. Preceded by Plan 832 then Plan 732.",
    minAge: 0, maxAge: 12, minTerm: 20, maxTerm: 25, minSA: 25000,
    ppt: "term_minus_3", gstCategory: "child", riders: [],
    keyFeatures: ["Money back at milestones","Child plan","With profit"],
    tags: ["Withdrawn", "Child", "Money back"],
  },
  {
    id: "114", planNo: 114, name: "Jeevan Aadhar", shortName: "Jeevan Aadhar",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "Plan for handicapped dependants. Provides financial security for disabled family members.",
    minAge: 18, maxAge: 65, minTerm: 10, maxTerm: 30, minSA: 25000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["For handicapped dependants","Annual benefit payout","With profit"],
    tags: ["Withdrawn", "Special needs"],
  },
  {
    id: "117", planNo: 117, name: "Jeevan Saritha", shortName: "Jeevan Saritha",
    category: "pension", type: "participating", status: "withdrawn",
    withdrawnDate: "2000-02-16",
    desc: "Joint life deferred annuity. Both spouses receive pension post vesting.",
    minAge: 18, maxAge: 55, minTerm: 5, maxTerm: 35, minSA: 10000,
    ppt: "same", gstCategory: "pension", riders: [],
    keyFeatures: ["Joint life annuity","Deferred pension","With profit"],
    tags: ["Withdrawn", "Pension", "Joint life"],
  },
  {
    id: "121", planNo: 121, name: "Asha Deep II", shortName: "Asha Deep II",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2004-08-31",
    desc: "Health insurance + endowment hybrid. Enhanced CI cover over Asha Deep.",
    minAge: 18, maxAge: 55, minTerm: 10, maxTerm: 25, minSA: 50000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Health + endowment","Enhanced CI benefit","With profit"],
    tags: ["Withdrawn", "Health"],
  },
  {
    id: "122", planNo: 122, name: "Jeevan Suraksha (Endowment Type)", shortName: "Jeevan Suraksha",
    category: "pension", type: "participating", status: "withdrawn",
    withdrawnDate: "1998-06-04",
    desc: "Pension plan — endowment type. Build corpus then convert to annuity.",
    minAge: 18, maxAge: 60, minTerm: 10, maxTerm: 35, minSA: 25000,
    ppt: "same", gstCategory: "pension", riders: [],
    keyFeatures: ["Pension endowment type","With profit","Convert to annuity"],
    tags: ["Withdrawn", "Pension"],
  },
  {
    id: "123", planNo: 123, name: "Jeevan Sanchay (12 Year)", shortName: "Jeevan Sanchay 12yr",
    category: "endowment", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2002-03-16",
    desc: "12-year non-par endowment with guaranteed additions.",
    minAge: 13, maxAge: 55, minTerm: 12, maxTerm: 12, minSA: 25000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["12-year fixed term","Guaranteed additions","Without profit"],
    tags: ["Withdrawn", "Endowment", "Guaranteed"],
  },
  {
    id: "124", planNo: 124, name: "Jeevan Sanchay (15 Year)", shortName: "Jeevan Sanchay 15yr",
    category: "endowment", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2002-03-16",
    desc: "15-year non-par endowment with guaranteed additions.",
    minAge: 13, maxAge: 55, minTerm: 15, maxTerm: 15, minSA: 25000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["15-year fixed term","Guaranteed additions","Without profit"],
    tags: ["Withdrawn", "Endowment", "Guaranteed"],
  },
  {
    id: "125", planNo: 125, name: "Jeevan Sanchay (20 Year)", shortName: "Jeevan Sanchay 20yr",
    category: "moneyback", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2002-03-16",
    desc: "20-year money back with guaranteed additions of ₹70/1000 SA/yr. 20% SB at 5th, 10th, 15th year.",
    minAge: 13, maxAge: 50, minTerm: 20, maxTerm: 20, minSA: 25000,
    ppt: "same", gstCategory: "moneyback", riders: [],
    keyFeatures: ["GA ₹70/1000 SA/yr","20% SA at year 5, 10, 15","40% SA + GA + LA at maturity","Accident benefit ₹1/1000 SA extra"],
    tags: ["Withdrawn", "Money back", "Guaranteed additions"],
  },
  {
    id: "126", planNo: 126, name: "Jeevan Sanchay (25 Year)", shortName: "Jeevan Sanchay 25yr",
    category: "moneyback", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2002-03-16",
    desc: "25-year money back with guaranteed additions. Similar to Plan 125 with longer term.",
    minAge: 13, maxAge: 45, minTerm: 25, maxTerm: 25, minSA: 25000,
    ppt: "same", gstCategory: "moneyback", riders: [],
    keyFeatures: ["GA ₹70/1000 SA/yr","Periodic money back","Without profit"],
    tags: ["Withdrawn", "Money back", "Guaranteed additions"],
  },
  {
    id: "128", planNo: 128, name: "Jeevan Sneha (20 Year)", shortName: "Jeevan Sneha",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2001-12-31",
    desc: "20-year endowment with profit for women.",
    minAge: 18, maxAge: 50, minTerm: 20, maxTerm: 20, minSA: 25000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["For women","20-year term","With profit"],
    tags: ["Withdrawn", "Endowment", "Women"],
  },
  {
    id: "131", planNo: 131, name: "Jeevan Asha II", shortName: "Jeevan Asha II",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2003-10-16",
    desc: "Health insurance plan with endowment benefit.",
    minAge: 18, maxAge: 55, minTerm: 10, maxTerm: 25, minSA: 50000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Health + endowment","With profit"],
    tags: ["Withdrawn", "Health"],
  },
  {
    id: "133", planNo: 133, name: "Jeevan Mithra (Triple Cover)", shortName: "Jeevan Mithra TC",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2002-03-16",
    desc: "Endowment with triple SA on accidental death. With profit.",
    minAge: 18, maxAge: 50, minTerm: 15, maxTerm: 30, minSA: 50000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Triple SA on accidental death","With profit","Premium SA rebate"],
    tags: ["Withdrawn", "Triple cover"],
  },
  {
    id: "136", planNo: 136, name: "Jeevan Viswas", shortName: "Jeevan Viswas",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "Endowment plan for handicapped dependants. Annual survival benefits after PPT.",
    minAge: 20, maxAge: 65, minTerm: 10, maxTerm: 35, minSA: 50000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["For handicapped dependants","Annual survival benefit","With profit"],
    tags: ["Withdrawn", "Special needs"],
  },
  {
    id: "140", planNo: 140, name: "Bima Plus", shortName: "Bima Plus",
    category: "ulip", type: "ulip", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "Early LIC ULIP plan. Market-linked returns with life cover.",
    minAge: 0, maxAge: 60, minTerm: 10, maxTerm: 20, minPremium: 10000,
    ppt: "same", gstCategory: "ulip", riders: [],
    keyFeatures: ["Early ULIP","Market-linked","Life cover"],
    tags: ["Withdrawn", "ULIP"],
  },
  {
    id: "149", planNo: 149, name: "Jeevan Anand (Whole Life)", shortName: "Jeevan Anand (old)",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "Predecessor to New Jeevan Anand (Plan 715). Endowment with lifetime cover.",
    minAge: 18, maxAge: 50, minTerm: 15, maxTerm: 35, minSA: 100000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Life cover continues post maturity","With profit","Succeeded by Plan 715/815"],
    tags: ["Withdrawn", "Endowment", "Whole life"],
  },
  {
    id: "150", planNo: 150, name: "New Bima Kiran", shortName: "New Bima Kiran",
    category: "term", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2002-02-18",
    desc: "Revised term plan. Pure life cover, no savings.",
    minAge: 18, maxAge: 60, minTerm: 10, maxTerm: 30, minSA: 50000,
    ppt: "same", gstCategory: "term", riders: [],
    keyFeatures: ["Pure term","Without profit","Enhanced over Plan 111"],
    tags: ["Withdrawn", "Term"],
  },
  {
    id: "151", planNo: 151, name: "New Jeevan Shree", shortName: "New Jeevan Shree (old)",
    category: "endowment", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "Non-par endowment with guaranteed additions. Predecessor to Plan 911/912.",
    minAge: 18, maxAge: 55, minTerm: 10, maxTerm: 25, minSA: 100000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Guaranteed additions","Without profit","Succeeded by Plan 911/912"],
    tags: ["Withdrawn", "Endowment", "Guaranteed"],
  },
  {
    id: "152", planNo: 152, name: "Jeevan Rekha", shortName: "Jeevan Rekha",
    category: "wholelife", type: "participating", status: "withdrawn",
    withdrawnDate: "2006-03-17",
    desc: "Whole life money back plan. Survival benefits during term plus whole life cover.",
    minAge: 18, maxAge: 55, minTerm: 20, maxTerm: 35, minSA: 50000,
    ppt: "same", gstCategory: "wholelife", riders: [],
    keyFeatures: ["Whole life + money back","Survival benefits at intervals","With profit"],
    tags: ["Withdrawn", "Whole life", "Money back"],
  },
  {
    id: "153", planNo: 153, name: "Anmol Jeevan", shortName: "Anmol Jeevan",
    category: "term", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2002-10-31",
    desc: "Pure term assurance plan at very affordable premiums.",
    minAge: 18, maxAge: 55, minTerm: 5, maxTerm: 25, minSA: 25000,
    ppt: "same", gstCategory: "term", riders: [],
    keyFeatures: ["Affordable term","Without profit","Pure protection"],
    tags: ["Withdrawn", "Term"],
  },
  {
    id: "154", planNo: 154, name: "Jeevan Samridhi (12 Year)", shortName: "Jeevan Samridhi 12yr",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2005-03-01",
    desc: "12-year endowment with profit. Short-term savings + insurance.",
    minAge: 13, maxAge: 55, minTerm: 12, maxTerm: 12, minSA: 25000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["12-year term","With profit","Short-term savings"],
    tags: ["Withdrawn", "Endowment"],
  },
  {
    id: "155", planNo: 155, name: "Jeevan Samridhi (15 Year)", shortName: "Jeevan Samridhi 15yr",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2005-03-01",
    desc: "15-year endowment with profit.",
    minAge: 13, maxAge: 55, minTerm: 15, maxTerm: 15, minSA: 25000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["15-year term","With profit"],
    tags: ["Withdrawn", "Endowment"],
  },
  {
    id: "156", planNo: 156, name: "Jeevan Samridhi (20 Year)", shortName: "Jeevan Samridhi 20yr",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2005-03-01",
    desc: "20-year endowment with profit.",
    minAge: 13, maxAge: 50, minTerm: 20, maxTerm: 20, minSA: 25000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["20-year term","With profit"],
    tags: ["Withdrawn", "Endowment"],
  },
  {
    id: "157", planNo: 157, name: "Jeevan Samridhi (25 Year)", shortName: "Jeevan Samridhi 25yr",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2005-03-01",
    desc: "25-year endowment with profit.",
    minAge: 13, maxAge: 45, minTerm: 25, maxTerm: 25, minSA: 25000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["25-year term","With profit"],
    tags: ["Withdrawn", "Endowment"],
  },
  {
    id: "159", planNo: 159, name: "Komal Jeevan", shortName: "Komal Jeevan",
    category: "child", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "Children's endowment plan. Risk commences from age 7, premium waiver on parent's death.",
    minAge: 0, maxAge: 10, minTerm: 15, maxTerm: 25, minSA: 50000,
    ppt: "same", gstCategory: "child", riders: [],
    keyFeatures: ["Child plan","Premium waiver on parent death","With profit"],
    tags: ["Withdrawn", "Child"],
  },
  {
    id: "165", planNo: 165, name: "Jeevan Saral", shortName: "Jeevan Saral",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "Simple flexible endowment. Choose premium, SA auto-calculated. Popular for simplicity.",
    minAge: 12, maxAge: 60, minTerm: 10, maxTerm: 35, minSA: 50000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Choose premium, SA calculated automatically","Flexible","With profit","Loyalty addition at maturity"],
    tags: ["Withdrawn", "Endowment", "Flexible"],
  },
  {
    id: "168", planNo: 168, name: "Jeevan Anurag", shortName: "Jeevan Anurag",
    category: "moneyback", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "Child money back plan. Survival benefits at child's key milestones.",
    minAge: 0, maxAge: 12, minTerm: 20, maxTerm: 25, minSA: 100000,
    ppt: "term_minus_3", gstCategory: "child", riders: [],
    keyFeatures: ["Child money back","Milestone payouts","With profit","Premium waiver"],
    tags: ["Withdrawn", "Child", "Money back"],
  },
  {
    id: "178", planNo: 178, name: "Jeevan Tarang", shortName: "Jeevan Tarang",
    category: "wholelife", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "Guaranteed income whole life plan. Guaranteed additions + annual survival benefit for life.",
    minAge: 0, maxAge: 60, minTerm: 100, maxTerm: 100, minSA: 100000,
    ppt: "limited", gstCategory: "wholelife", riders: [],
    keyFeatures: ["Guaranteed additions during PPT","Annual income for life","Similar to Jeevan Utsav concept","Non-participating"],
    tags: ["Withdrawn", "Whole life", "Guaranteed income"],
  },
  {
    id: "184", planNo: 184, name: "Child Career Plan", shortName: "Child Career Plan",
    category: "child", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "Children's plan focused on career funding. Payouts at ages 17–21.",
    minAge: 0, maxAge: 12, minTerm: 17, maxTerm: 25, minSA: 100000,
    ppt: "same", gstCategory: "child", riders: [],
    keyFeatures: ["Career funding payouts","Ages 17–21","With profit","PWB available"],
    tags: ["Withdrawn", "Child", "Career"],
  },
  {
    id: "185", planNo: 185, name: "Child Future Plan", shortName: "Child Future Plan",
    category: "child", type: "participating", status: "withdrawn",
    withdrawnDate: "2014-01-01",
    desc: "Children's comprehensive plan. Covers education, career, and marriage milestones.",
    minAge: 0, maxAge: 12, minTerm: 17, maxTerm: 25, minSA: 100000,
    ppt: "same", gstCategory: "child", riders: [],
    keyFeatures: ["Education + career + marriage milestones","With profit","PWB"],
    tags: ["Withdrawn", "Child"],
  },

  // ── Recently withdrawn 700-series ─────────────
  {
    id: "735", planNo: 735, name: "Endowment Plus", shortName: "Endowment Plus",
    category: "ulip", type: "ulip", status: "withdrawn",
    withdrawnDate: "2026-03-01",
    desc: "ULIP endowment plan. Market-linked with life cover. Withdrawn March 2026.",
    minAge: 0, maxAge: 60, minTerm: 10, maxTerm: 20, minPremium: 30000,
    ppt: "same", gstCategory: "ulip", riders: [],
    keyFeatures: ["ULIP endowment","Market-linked","Withdrawn March 2026"],
    tags: ["Withdrawn", "ULIP"],
  },
  {
    id: "764", planNo: 764, name: "Bima Ratna", shortName: "Bima Ratna",
    category: "moneyback", type: "participating", status: "withdrawn",
    withdrawnDate: "2026-03-01",
    desc: "Non-par money back plan with guaranteed additions. Withdrawn March 2026.",
    minAge: 5, maxAge: 55, minTerm: 15, maxTerm: 25, minSA: 500000,
    ppt: "limited", gstCategory: "moneyback", riders: [],
    keyFeatures: ["Non-par money back","Guaranteed additions","Min SA ₹5 lakh","Withdrawn March 2026"],
    tags: ["Withdrawn", "Money back", "Guaranteed"],
  },
  {
    id: "768", planNo: 768, name: "Jeevan Azad", shortName: "Jeevan Azad",
    category: "endowment", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2026-03-01",
    desc: "Limited payment non-par endowment with guaranteed additions. Withdrawn March 2026.",
    minAge: 8, maxAge: 55, minTerm: 15, maxTerm: 25, minSA: 200000,
    ppt: "limited", gstCategory: "endowment", riders: [],
    keyFeatures: ["Limited pay","Guaranteed additions","Non-par","Withdrawn March 2026"],
    tags: ["Withdrawn", "Endowment", "Limited pay"],
  },

  // ── 800-series withdrawn (predecessors to current active plans) ───
  {
    id: "814", planNo: 814, name: "New Endowment Plan", shortName: "New Endowment (814)",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2020-02-01",
    desc: "Predecessor to Plan 714. Classic endowment with annual bonus. Withdrawn Feb 2020.",
    minAge: 8, maxAge: 55, minTerm: 12, maxTerm: 35, minSA: 100000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Classic endowment","With profit","Succeeded by Plan 714"],
    tags: ["Withdrawn", "Endowment"],
  },
  {
    id: "815", planNo: 815, name: "New Jeevan Anand", shortName: "New Jeevan Anand (815)",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2020-01-31",
    desc: "Predecessor to Plan 715. Endowment + whole life cover continues post maturity.",
    minAge: 18, maxAge: 50, minTerm: 15, maxTerm: 35, minSA: 100000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Life cover continues post maturity","With profit","Succeeded by Plan 715"],
    tags: ["Withdrawn", "Endowment", "Whole life"],
  },
  {
    id: "818", planNo: 818, name: "New Jeevan Nidhi", shortName: "New Jeevan Nidhi",
    category: "pension", type: "participating", status: "withdrawn",
    withdrawnDate: "2020-01-16",
    desc: "Pension plan with profit participation. Deferred annuity.",
    minAge: 20, maxAge: 60, minTerm: 5, maxTerm: 35, minSA: 100000,
    ppt: "same", gstCategory: "pension", riders: [],
    keyFeatures: ["Deferred annuity","With profit","Withdrawn Jan 2020"],
    tags: ["Withdrawn", "Pension"],
  },
  {
    id: "820", planNo: 820, name: "New Money Back Plan – 20 Year", shortName: "Money Back 20yr (820)",
    category: "moneyback", type: "participating", status: "withdrawn",
    withdrawnDate: "2020-02-01",
    desc: "Predecessor to Plan 720. 20% SA every 5 years, 40% SA at maturity + bonuses.",
    minAge: 13, maxAge: 50, minTerm: 20, maxTerm: 20, minSA: 100000,
    ppt: 15, gstCategory: "moneyback", riders: [],
    keyFeatures: ["20% SA at years 5/10/15","40% SA + bonus at maturity","Succeeded by Plan 720"],
    tags: ["Withdrawn", "Money back"],
  },
  {
    id: "821", planNo: 821, name: "New Money Back Plan – 25 Year", shortName: "Money Back 25yr (821)",
    category: "moneyback", type: "participating", status: "withdrawn",
    withdrawnDate: "2020-02-01",
    desc: "Predecessor to Plan 721. 15% SA every 5 years (4 times), 40% SA at maturity.",
    minAge: 13, maxAge: 45, minTerm: 25, maxTerm: 25, minSA: 100000,
    ppt: 20, gstCategory: "moneyback", riders: [],
    keyFeatures: ["15% SA at years 5/10/15/20","40% SA + bonus at maturity","Succeeded by Plan 721"],
    tags: ["Withdrawn", "Money back"],
  },
  {
    id: "823", planNo: 823, name: "Amulya Jeevan II", shortName: "Amulya Jeevan II",
    category: "term", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2019-08-05",
    desc: "Term assurance plan. Pure life cover at affordable premiums.",
    minAge: 18, maxAge: 60, minTerm: 5, maxTerm: 35, minSA: 2500000,
    ppt: "same", gstCategory: "term", riders: [],
    keyFeatures: ["Pure term","Min SA ₹25 lakh","Affordable premiums"],
    tags: ["Withdrawn", "Term"],
  },
  {
    id: "827", planNo: 827, name: "Jeevan Rakshak", shortName: "Jeevan Rakshak",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2019-11-01",
    desc: "Low-cost endowment for small SA. Max SA ₹2 lakh.",
    minAge: 8, maxAge: 55, minTerm: 10, maxTerm: 20, minSA: 75000, maxSA: 200000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Max SA ₹2 lakh","Affordable","With profit","Low-income segment"],
    tags: ["Withdrawn", "Endowment", "Low cost"],
  },
  {
    id: "830", planNo: 830, name: "Limited Premium Endowment Plan", shortName: "LPE (830)",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2020-02-01",
    desc: "Limited pay endowment. Similar structure to Jeevan Labh (736).",
    minAge: 18, maxAge: 59, minTerm: 16, maxTerm: 25, minSA: 300000,
    ppt: "limited", gstCategory: "endowment", riders: [],
    keyFeatures: ["Limited premium payment","With profit","High bonus rate"],
    tags: ["Withdrawn", "Limited pay", "Endowment"],
  },
  {
    id: "832", planNo: 832, name: "New Children's Money Back Plan", shortName: "Child MB (832)",
    category: "child", type: "participating", status: "withdrawn",
    withdrawnDate: "2020-02-01",
    desc: "Predecessor to Plan 732. Money back at child's ages 18, 20, 22. Maturity at 25.",
    minAge: 0, maxAge: 12, minTerm: 25, maxTerm: 25, minSA: 100000,
    ppt: "term_minus_3", gstCategory: "child", riders: [],
    keyFeatures: ["20% SA at age 18/20/22","40% SA at age 25","PWB on parent death","Succeeded by Plan 732"],
    tags: ["Withdrawn", "Child", "Money back"],
  },
  {
    id: "833", planNo: 833, name: "New Jeevan Lakshya", shortName: "New Jeevan Lakshya (833)",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2020-02-01",
    desc: "Predecessor to Plan 733. Family income plan — 10% SA annually on death till maturity.",
    minAge: 18, maxAge: 50, minTerm: 13, maxTerm: 25, minSA: 100000,
    ppt: "term_minus_3", gstCategory: "endowment", riders: [],
    keyFeatures: ["10% SA annual income on death","Family income plan","Succeeded by Plan 733"],
    tags: ["Withdrawn", "Family income"],
  },
  {
    id: "835", planNo: 835, name: "New Endowment Plus", shortName: "New Endowment Plus",
    category: "ulip", type: "ulip", status: "withdrawn",
    withdrawnDate: "2020-02-01",
    desc: "ULIP endowment plan. Market-linked with guaranteed additions.",
    minAge: 0, maxAge: 60, minTerm: 10, maxTerm: 20, minPremium: 20000,
    ppt: "same", gstCategory: "ulip", riders: [],
    keyFeatures: ["ULIP with guaranteed additions","Market-linked","Withdrawn Feb 2020"],
    tags: ["Withdrawn", "ULIP"],
  },
  {
    id: "836", planNo: 836, name: "New Jeevan Labh", shortName: "New Jeevan Labh (836)",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2020-02-01",
    desc: "Predecessor to Plan 736 (Jeevan Labh). Limited pay high-bonus endowment.",
    minAge: 8, maxAge: 59, minTerm: 16, maxTerm: 25, minSA: 200000,
    pptOptions: [{ ppt: 10, term: 16 }, { ppt: 15, term: 21 }, { ppt: 16, term: 25 }],
    ppt: "limited", gstCategory: "endowment", riders: [],
    keyFeatures: ["Limited pay 10/15/16 yrs","High bonus rate","Succeeded by Plan 736"],
    tags: ["Withdrawn", "Limited pay", "High returns"],
  },
  {
    id: "838", planNo: 838, name: "Jeevan Pragati", shortName: "Jeevan Pragati",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2020-02-01",
    desc: "Endowment with increasing life cover every 5 years. With profit.",
    minAge: 12, maxAge: 45, minTerm: 12, maxTerm: 20, minSA: 150000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["SA increases every 5 years","With profit","Growing coverage"],
    tags: ["Withdrawn", "Endowment", "Increasing cover"],
  },
  {
    id: "841", planNo: 841, name: "Bima Diamond", shortName: "Bima Diamond",
    category: "moneyback", type: "participating", status: "withdrawn",
    withdrawnDate: "2017-08-31",
    desc: "Money back plan with guaranteed loyalty additions at maturity.",
    minAge: 14, maxAge: 50, minTerm: 16, maxTerm: 24, minSA: 100000,
    ppt: "limited", gstCategory: "moneyback", riders: [],
    keyFeatures: ["Periodic money back","Guaranteed loyalty additions","With profit"],
    tags: ["Withdrawn", "Money back"],
  },
  {
    id: "843", planNo: 843, name: "Aadhaar Stambh", shortName: "Aadhaar Stambh",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2020-02-01",
    desc: "Endowment for males under govt. Aadhaar identity scheme. With profit.",
    minAge: 8, maxAge: 55, minTerm: 10, maxTerm: 20, minSA: 75000, maxSA: 300000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Aadhaar-linked plan for males","Max SA ₹3 lakh","With profit"],
    tags: ["Withdrawn", "Endowment", "Aadhaar"],
  },
  {
    id: "844", planNo: 844, name: "Aadhaar Shila", shortName: "Aadhaar Shila",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2017-04-01",
    desc: "Endowment for women under Aadhaar scheme. With profit. Max SA ₹3 lakh.",
    minAge: 8, maxAge: 55, minTerm: 10, maxTerm: 20, minSA: 75000, maxSA: 300000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["For women — Aadhaar linked","Max SA ₹3 lakh","With profit"],
    tags: ["Withdrawn", "Endowment", "Women", "Aadhaar"],
  },
  {
    id: "845", planNo: 845, name: "Jeevan Umang (845)", shortName: "Jeevan Umang (845)",
    category: "wholelife", type: "participating", status: "withdrawn",
    withdrawnDate: "2020-02-01",
    desc: "Predecessor to Plan 745. Whole life with 8% SA annual income after PPT.",
    minAge: 0, maxAge: 55, minTerm: 100, maxTerm: 100, minSA: 200000,
    pptOptions: [15, 20, 25, 30], ppt: "limited", gstCategory: "wholelife", riders: [],
    keyFeatures: ["8% SA annual income after PPT","Whole life cover","Succeeded by Plan 745"],
    tags: ["Withdrawn", "Whole life", "Regular income"],
  },
  {
    id: "846", planNo: 846, name: "Jeevan Utkarsh", shortName: "Jeevan Utkarsh",
    category: "endowment", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2018-06-03",
    desc: "Single premium endowment with guaranteed additions. Short-term investment.",
    minAge: 6, maxAge: 47, minTerm: 12, maxTerm: 12, minSA: 75000,
    ppt: "single", gstCategory: "singlePrem", riders: [],
    keyFeatures: ["Single premium","12-year fixed term","Guaranteed additions","Without profit"],
    tags: ["Withdrawn", "Single premium", "Endowment"],
  },
  {
    id: "847", planNo: 847, name: "Jeevan Shiromani", shortName: "Jeevan Shiromani",
    category: "moneyback", type: "participating", status: "withdrawn",
    withdrawnDate: "2020-02-01",
    desc: "HNI money back plan. Min SA ₹1 crore. Critical illness cover included.",
    minAge: 18, maxAge: 55, minTerm: 20, maxTerm: 28, minSA: 10000000,
    ppt: "limited", gstCategory: "moneyback", riders: [],
    keyFeatures: ["Min SA ₹1 crore — super HNI","Critical illness cover","Limited pay","With profit"],
    tags: ["Withdrawn", "HNI", "Money back"],
  },
  {
    id: "848", planNo: 848, name: "Bima Shree (848)", shortName: "Bima Shree (848)",
    category: "moneyback", type: "participating", status: "withdrawn",
    withdrawnDate: "2023-03-30",
    desc: "Predecessor to Plan 748. HNI limited pay money back. Min SA ₹10 lakh.",
    minAge: 8, maxAge: 55, minTerm: 20, maxTerm: 28, minSA: 1000000,
    ppt: "limited", gstCategory: "moneyback", riders: [],
    keyFeatures: ["Min SA ₹10 lakh","Limited pay","With profit","Succeeded by Plan 748"],
    tags: ["Withdrawn", "HNI", "Money back"],
  },
  {
    id: "850", planNo: 850, name: "Jeevan Shanti", shortName: "Jeevan Shanti (850)",
    category: "pension", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2019-08-24",
    desc: "Predecessor to New Jeevan Shanti (758). Single premium annuity plan.",
    minAge: 30, maxAge: 79, minTerm: 0, maxTerm: 12, minSA: 100000,
    ppt: "single", gstCategory: "singlePrem", riders: [],
    keyFeatures: ["Immediate or deferred annuity","Single premium","Succeeded by Plan 758"],
    tags: ["Withdrawn", "Pension", "Annuity"],
  },
  {
    id: "853", planNo: 853, name: "Navjeevan", shortName: "Navjeevan",
    category: "endowment", type: "participating", status: "withdrawn",
    withdrawnDate: "2020-03-31",
    desc: "Endowment with increasing cover. SA grows by 5% every year for first 5 years.",
    minAge: 18, maxAge: 50, minTerm: 10, maxTerm: 30, minSA: 100000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Increasing SA for first 5 years","With profit","Enhanced death cover"],
    tags: ["Withdrawn", "Endowment", "Increasing cover"],
  },
  {
    id: "855", planNo: 855, name: "Jeevan Amar (855)", shortName: "Jeevan Amar (855)",
    category: "term", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2019-08-05",
    desc: "Predecessor to Plan 955. Term with level/increasing SA option.",
    minAge: 18, maxAge: 65, minTerm: 10, maxTerm: 40, minSA: 2500000,
    ppt: "same", gstCategory: "term", riders: [],
    keyFeatures: ["Level or increasing SA","High cover","Succeeded by Plan 955"],
    tags: ["Withdrawn", "Term", "High cover"],
  },
  {
    id: "860", planNo: 860, name: "Bima Jyoti (860)", shortName: "Bima Jyoti (860)",
    category: "endowment", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2021-12-20",
    desc: "Predecessor to Plan 760. Non-par endowment with guaranteed additions.",
    minAge: 0, maxAge: 60, minTerm: 15, maxTerm: 20, minSA: 100000,
    ppt: "same", gstCategory: "endowment", riders: [],
    keyFeatures: ["Guaranteed additions ₹50/1000 SA/yr","Non-par","Succeeded by Plan 760"],
    tags: ["Withdrawn", "Endowment", "Guaranteed"],
  },
  {
    id: "863", planNo: 863, name: "Dhan Rekha", shortName: "Dhan Rekha",
    category: "moneyback", type: "non-participating", status: "withdrawn",
    withdrawnDate: "2023-03-31",
    desc: "Non-par money back plan with guaranteed additions. Periodic payouts assured.",
    minAge: 3, maxAge: 45, minTerm: 20, maxTerm: 28, minSA: 500000,
    ppt: "limited", gstCategory: "moneyback", riders: [],
    keyFeatures: ["Guaranteed additions","Non-par money back","Periodic assured payouts"],
    tags: ["Withdrawn", "Money back", "Guaranteed"],
  },
  {
    id: "872", planNo: 872, name: "Jeevan Dhara-II", shortName: "Jeevan Dhara-II",
    category: "pension", type: "participating", status: "withdrawn",
    withdrawnDate: "2024-10-31",
    desc: "Deferred annuity pension plan. Build corpus with regular premiums, convert at vesting.",
    minAge: 20, maxAge: 70, minTerm: 5, maxTerm: 40, minSA: 100000,
    ppt: "same", gstCategory: "pension", riders: [],
    keyFeatures: ["Deferred annuity","With profit","Flexible vesting age","Withdrawn Oct 2024"],
    tags: ["Withdrawn", "Pension"],
  },
];
...
export function getTabularRate(planNo, age, term) {
  ...
  // For pension annuity plans, keys are strings ('immediate', 'deferred5', etc.) — skip numeric sort
  const termKeys = Object.keys(termMap);
  const numericTerms = termKeys.map(Number).filter(n => !isNaN(n));
  if (!numericTerms.length) return 50; // pension plans — use getPensionAnnuityRate instead
  const nearTerm = numericTerms.sort((a, b) => a - b).reduce((p, c) =>
    Math.abs(c - term) < Math.abs(p - term) ? c : p, numericTerms[0]);
  return termMap[nearTerm] || 50;
}

// Returns annuity rate (₹ annual pension per ₹1000 purchase price) for pension annuity plans
export function getPensionAnnuityRate(planNo, age, option = 'immediate') {
  const tbl = TABULAR_RATES[planNo];
  if (!tbl) return null;
  const ages = Object.keys(tbl).map(Number).sort((a, b) => a - b);
  const nearAge = ages.reduce((p, c) =>
    Math.abs(c - age) < Math.abs(p - age) ? c : p, ages[0]);
  const termMap = tbl[nearAge] || {};
  // Return requested option, fall back to 'immediate'
  return termMap[option] ?? termMap['immediate'] ?? null;
}
...
export function calculatePremium({ planNo, sa, age, term, ppt, mode = "yearly", smoker = false, gender = "male" }) {
  ...
  // Pension annuity plans (758, 857, 862, 879) — single premium, immediate/deferred annuity
  const PENSION_ANNUITY_PLANS = [758, 857, 862, 879];
  if (PENSION_ANNUITY_PLANS.includes(planNo)) {
    // sa = purchasePrice (caller passes purchasePrice as sa)
    const purchasePrice = sa;
    const annuityOption = 'immediate'; // default; UI can pass specific option later
    const annuityRate = getPensionAnnuityRate(planNo, age, annuityOption);
    if (!annuityRate) return null;
    const annualPension = Math.round((annuityRate / 1000) * purchasePrice);
    const gstAmt = Math.round(purchasePrice * 0.018);
    return {
      isPensionAnnuity: true,
      annuityRate,
      purchasePrice,
      annualPension,
      monthlyPension: Math.round(annualPension / 12),
      quarterlyPension: Math.round(annualPension / 4),
      halfYearlyPension: Math.round(annualPension / 2),
      gst: gstAmt,
      totalPayable: purchasePrice + gstAmt,
      // These fields keep compatibility with generic display code
      yearlyYear1: purchasePrice + gstAmt,
      yearlyYear2plus: 0,
      instalment1: purchasePrice + gstAmt,
      instalment2: 0,
      totalPaid: purchasePrice + gstAmt,
      netPremium: purchasePrice,
      gstYear1: gstAmt,
      gstYear2: 0,
    };
  }

    ...
    <div className="pt-20">
      ...
      <section className="bg-hero-gradient hero-pattern section-padding">
        <div className="section-container">
          <div className="grid lg:grid-cols-2 gap-12 items-center text-white">
            <div>
              <div className="inline-flex items-center gap-2 bg-white/15 border border-white/25 rounded-full px-4 py-2 text-sm font-medium mb-6">🏢 {lang === 'en' ? 'Corporate Protection' : 'कॉर्पोरेट सुरक्षा'}</div>
      ...
      <section className="section-padding bg-white">
        <div className="section-container">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="section-title mb-6">{t.keyman.benefitsTitle}</h2>
              <ul className="space-y-3">
                {t.keyman.benefits.map((benefit, i) => (
      ...
      <section className="py-12 bg-slate-50 border-y border-slate-100 text-center">
        <div className="max-w-xl mx-auto px-6">
          <h3 className="font-display font-bold text-22 text-slate-900 mb-2">{t.keyman.contactTitle}</h3>
          <p className="text-slate-500 text-sm mb-6">{t.keyman.contactSub}</p>
          <a
            href={WA_LINK}
            target="_blank"
            rel="noopener noreferrer"
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12">
              <div className="text-center mb-8">
                <h2 className="font-display font-bold text-2xl text-slate-900 mb-2">{lang === 'en' ? 'Get a Custom Keyman Proposal' : 'कस्टम कीमैन प्रस्ताव प्राप्त करें'}</h2>
              ...
              <BaseLeadForm
                fields={fields}
                intent="keyman-insurance"
                submitText={lang === 'en' ? 'Submit Proposal Request →' : 'प्रस्ताव अनुरोध भेजें →'}

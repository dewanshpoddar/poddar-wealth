...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafbfc] text-navy">
      ...
      <section className="py-12 px-6 max-w-[1400px] mx-auto -mt-8 relative z-20">
        <div className="bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-gray-100/80">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {milestoneTriggers.map((trig, idx) => (
              <button
                ...
                className="flex items-start gap-4 p-5 rounded-2xl border border-gray-100 hover:border-gold/30 hover:bg-gold/[0.02] hover:-translate-y-1 transition-all duration-300 text-left cursor-pointer group"
              >
      ...
      <section id="catalog-section" className="py-8 text-center px-6">

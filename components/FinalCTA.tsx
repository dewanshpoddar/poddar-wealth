...
export default function FinalCTA() {
  ...
  return (
    <section className="bg-gray-950 py-16 md:py-20 px-4 text-white">
      <div className="max-w-5xl mx-auto grid gap-8 md:gap-12 items-center" style={{ gridTemplateColumns: 'revert' }}>
        <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center md:items-start bg-white/5 p-8 rounded-[32px] border border-white/10 shadow-lg text-white">
          {/* Photo container */}
          <div className="shrink-0 w-48 h-64 sm:w-64 sm:h-80 rounded-2xl bg-slate-900 border border-white/10 shadow-inner relative overflow-hidden group/photo">
            <Image 
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <h2 className="text-white text-2xl md:text-3xl font-bold mb-4">{t.aboutSection.name}</h2>
            ...
            <p className="text-[14px] text-white/70 leading-relaxed max-w-2xl">{t.aboutSection.bio}</p>
          </div>
        </div>
      </div>
    </section>

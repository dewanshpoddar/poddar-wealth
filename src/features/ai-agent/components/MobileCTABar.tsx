    ...
    >
      ...
      <a
        ...
        className="
          ...
          py-3.5 px-4
          text-navy font-semibold text-[14px]
          hover:bg-slate-50 active:bg-slate-100
          transition-colors
          border-r border-slate-200/80
        "
        aria-label="Call Ajay sir"
      >
        <Phone size={16} className="text-navy flex-shrink-0" />
        <span>Call Ajay sir</span>
      </a>
      ...
      <a
        ...
        className="
          flex-1 flex items-center justify-center gap-2
          py-3.5 px-4
          bg-[#25D366] text-white font-semibold text-[14px]
          hover:bg-[#20c45a] active:bg-[#1aad50]
          transition-colors
        "

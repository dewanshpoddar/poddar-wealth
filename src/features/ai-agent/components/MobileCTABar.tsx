...
export default function MobileCTABar() {
  ...
  return (
    ...
    >
      ...
      >
        {/* WhatsApp icon — green icon only, not green background */}
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-[15px] h-[15px] flex-shrink-0 text-[#25D366]" aria-hidden="true">
